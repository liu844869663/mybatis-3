...
public class ResolverUtil<T> {
	...
	/**
	 * Attempts to discover classes that are assignable to the type provided. In the
	 * case that an interface is provided this method will collect implementations.
	 * In the case of a non-interface class, subclasses will be collected.
	 ...
	 * subpackages. Each class is offered up to the Test as it is discovered, and if
	 * the Test returns true the class is retained. Accumulated classes can be
